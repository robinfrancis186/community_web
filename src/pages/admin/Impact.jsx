...
const Impact = () => {
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-bold text-white mb-2">Impact Tracker</h1>
                <p className="text-gray-400">Measuring the real-world difference we make.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    <Card key={index} className="p-6 text-center" hover>
                        <div className={`w-12 h-12 mx-auto rounded-full bg-white/5 flex items-center justify-center mb-3 ${stat.color}`}>
                            <stat.icon size={24} />
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {/* Device Requirements */}
                <Card>
                    <h3 className="text-xl font-bold text-white mb-6">Device Requirements (District-wise)</h3>
                        ...
                        {[
                            ...
                            <div key={index}>
                                <div className="flex justify-between text-sm mb-1">
                                    <span className="text-white font-medium">{item.district}</span>
                                    <span className="text-gray-400">{item.fulfilled} / {item.needed}</span>
                                </div>
                ...
                {/* Assessment Progress */}
                <Card>
                    <h3 className="text-xl font-bold text-white mb-6">Assessment Goals</h3>
                    <div className="flex items-center justify-center h-64">
                        <div className="relative w-48 h-48">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                ...
                                <span className="text-xs text-gray-400">Goal Reached</span>
                            </div>
                        </div>
                    </div>
                </Card>
