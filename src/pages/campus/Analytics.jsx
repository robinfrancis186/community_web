    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-400">Detailed insights into campus performance.</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Participation Stats */}
                <Card>
                    <h3 className="text-lg font-bold text-white mb-6">Participation by Department</h3>
                ...
                <Card>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-4 rounded-xl bg-white/5 text-center">
                            ...
                            <div className="text-xs text-gray-400">Devices Distributed</div>
                        </div>
                        <div className="p-4 rounded-xl bg-white/5 text-center">
                            <div className="text-3xl font-bold text-blue-400 mb-1">2,400</div>
                            <div className="text-xs text-gray-400">Volunteer Hours</div>
                        </div>
                        <div className="p-4 rounded-xl bg-white/5 text-center">
                            <div className="text-3xl font-bold text-yellow-400 mb-1">15</div>
                            <div className="text-xs text-gray-400">Partner Schools</div>
                        </div>
                    </div>
                </Card>
            </div>
